...
export default class OnboardingAllowThings extends React.Component {
      ...
      return(
        ...
        >
          <View style={{
            ...
            <Image
              source={require('../assets/images/flashing-cameras.png')}
              style={{
                height: '100%',
                resizeMode: 'contain',
                //width: '70%'
          ...
          <View style={{
            ...
            >
              Allow Camera & Library
              {'\n'}
            </Text>
            <Text
              style={Colors.h3}
            >
              Our app requires permission to use your camera so you can help us capture the big day!
              {'\n\n'}
              Click to Allow now.
            </Text>
          </View>
